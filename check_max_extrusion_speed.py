...
params = {}
debug = False
for param in ["x_speed","y_speed","extrusion_speed","print_speed","debug"]:
...
while line:
    ...
    line = gcode.readline().strip().upper()
    line_number += 1
print "Maximum extrusion speed:",max_extrusion_speed
print "Maximum movement speed:",max_movement_speed
